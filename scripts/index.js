...
const bannerData = [
  {
    ...
    image_url: "/assets/footer_bg.png"
  },
  {
    ...
    image_url: "/assets/homepage_hero.png"
  }
];
...
window.onload = function() {
  ...
  function setupCanvas(canvasNode, images, index) {
    ...
    myImage.src = `/assets/${firstImg}.png`;
    myImage.onload = function() {
      drawRight(draw, myImage);
    }

    const myImage2 = new Image();
    myImage2.src = `/assets/${secondImg}.png`;
